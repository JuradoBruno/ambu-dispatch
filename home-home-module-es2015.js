...
let HomePage = class HomePage {
    ...
    addMinimap() {
        ...
        let osm = new leaflet__WEBPACK_IMPORTED_MODULE_2__["TileLayer"](this.osmStreetMap);
        let miniMap = new leaflet_minimap__WEBPACK_IMPORTED_MODULE_3___default.a(osm, {
            minZoom: 0,
            maxZoom: 13,
            toggleDisplay: true,
            minimized: false,
    ...
    addRouting() {
        let control = leaflet__WEBPACK_IMPORTED_MODULE_2__["Routing"].control({
            waypoints: [
    ...
    getTheTruckMoving(coords) {
        ...
        let marker = leaflet__WEBPACK_IMPORTED_MODULE_2__["movingMarker"]([37.809185, -122.477351], {
            destinations: coords,
...
const Leaflet = leaflet__WEBPACK_IMPORTED_MODULE_0__;
const noop = () => { };
;
